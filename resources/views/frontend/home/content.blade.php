        ...
        <div class="block-news-default-item">
          <div class="block-thumb">
            <a href="{{ route('news-detail', ['slug' => $tinThiTruong[0]['slug'], 'id' => $tinThiTruong[0]['id']]) }}" title="">
              <img src="{{ $tinThiTruong[0]['image_url'] ? Helper::showImageThumb($tinThiTruong[0]['image_url'], 2, '325x200') : URL::asset('admin/dist/img/no-image.jpg') }}" alt="">
            </a>
          </div>
                  ...
                  @foreach($hotProduct as $product)
                    <li class="news-new-item">                      
                      <div class="news-new-item-head">
                        <a  href="{{ route('chi-tiet', [$product->slug_loai, $product->slug, $product->id]) }}"><img  title="{{ $product->title }}" src="{{ $product->image_urls ? Helper::showImageThumb($product->image_urls) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="{{ $product->title }}" > 
                      ...
                      <div class="news-new-item-description">
                        ...
                        <img class="img-hot" src="{{ URL::asset('admin/dist/img/star.png')}}" alt="Nổi bật" title="Nổi bật" />
          ...
          <div class="news-fengshui clearfix">
           @if(isset($khonggiansong[0]))
            <div class="fengshui-news-hot">
                ...
                <img src="{{ $khonggiansong[0]['image_url'] ? Helper::showImageThumb($khonggiansong[0]['image_url'], 2) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="">
              </a>    
        ...
        <div class="block-contents">
          <div class="news-fengshui clearfix">
              ...
              <a href="{{ route('news-detail', ['slug' => $luat[0]['slug'], 'id' => $luat[0]['id']]) }}" title="">
                <img src="{{ $luat[0]['image_url'] ? Helper::showImageThumb($luat[0]['image_url'], 2, '325x200') : URL::asset('admin/dist/img/no-image.jpg') }}" alt="">
              </a>    
          ...
          <div class="news-fengshui clearfix">
           @if(isset($tuvan[0]))
            <div class="fengshui-news-hot">
                ...
                <img src="{{ $tuvan[0]['image_url'] ? Helper::showImageThumb($tuvan[0]['image_url'], 2) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="">
              </a>    
        ...
        <div class="block-contents">
          <div class="news-fengshui clearfix">
              ...
              <a href="{{ route('news-detail', ['slug' => $phongthuy[0]['slug'], 'id' => $phongthuy[0]['id']]) }}" title="">
                <img src="{{ $phongthuy[0]['image_url'] ? Helper::showImageThumb($phongthuy[0]['image_url'], 2, '325x200') : URL::asset('admin/dist/img/no-image.jpg') }}" alt="">
              </a>    
