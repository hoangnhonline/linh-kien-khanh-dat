		...
		<ul class="nav nav-tabs nav-tabs-langding" id="nav-tabs-langding" role="tablist">
			<li role="presentation" >
				<p class="tabs-item-logo">
					<i class="icon">
						<img src="{{ $detail->logo_url ? Helper::showImage($detail->logo_url) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="{{ $detail->name }}">
					</i>
				</p>
			</li>
			...
			<div role="tabpanel" class="tab-pane fade in active" id="Contact">
				...
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<img class="project-logo-contact" src="{{ $detail->logo_url ? Helper::showImage($detail->logo_url) : URL::asset('admin/dist/img/no-image.jpg') }}" alt="{{ $detail->name }}">
