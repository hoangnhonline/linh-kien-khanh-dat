          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="text-align:center"><a class="btn btn-info" href="<?php echo e(route('cate.index', [$item->id])); ?>"><?php echo e($item->products->count()); ?></a></td>                           
                
                <td style="white-space:nowrap; text-align:right">
                
                 <a class="btn btn-default btn-sm" href="<?php echo e(route('danh-muc-con', [$loaiSp->slug, $item->slug] )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>                  
