...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('loai-sp.index')); ?>" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <form role="form" method="POST" action="<?php echo e(route('loai-sp.update')); ?>">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('loai-sp.index')); ?>">Hủy</a>
            </div>
